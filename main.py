...
async def callback_handlers(bot: Client, cb: CallbackQuery):
    if "mergeNow" in cb.data:
        ...
        if Config.UPDATES_CHANNEL:
            ...
            try:
                ...
                if user.status == "kicked":
                    await cb.message.edit(
                        text="Sorry Sir, You are Banned to use me. Contact my [Support Group](https://t.me/movies_as_your_requests).",
                        parse_mode="markdown",
                        disable_web_page_preview=True
                    )
                    return
                ...
                await cb.message.edit(
                    text="Something went Wrong. Contact my [Support Group](https://t.me/movies_as_your_requests).",
                    parse_mode="markdown",
                    disable_web_page_preview=True
                )
                return
        await cb.message.edit(
            text=Config.START_TEXT,
            parse_mode="Markdown",
            reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Developer - @AJTITAN", url="https://t.me/AJTITAN"), InlineKeyboardButton("Support Group", url="https://t.me/movies_as_your_requests")], [InlineKeyboardButton("support Channel", url="https://t.me/ajmoviewebofficial")]]),
            disable_web_page_preview=True
        )
